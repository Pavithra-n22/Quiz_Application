...
public class Quiz extends JFrame implements  ActionListener  {
   ...
   String name;
    ...
    getContentPane().setBackground(Color.WHITE);
     ...
     ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("images/quiz.jpg"));   
       ...
       next.setBounds(1000, 500, 200, 30);
       next.setBackground(new Color(30,144,255));
       next.setForeground(Color.WHITE);
       next.addActionListener(this);
       next.setFont(new Font("Tahomag",Font.PLAIN,22));
       add(next);
   ...
   lifeline= new JButton("50-50 life line");
       ...
       lifeline.setFont(new Font("Tahomag",Font.PLAIN,22));
       add(lifeline);
